...
const icons = {
  ...
  hexa: {
    shape: (
        <path d="M7.20834 3.72896C7.33925 3.63288 7.47189 3.53503 7.6062 3.43594C9.72664 1.87153 12.2634 0 15.0008 0C18.0319 0 20.9517 2.15947 23.1094 3.78988C27.2547 4.60692 30 6.03206 30 7.65348C30 10.1895 23.2843 12.2453 15 12.2453C6.71573 12.2453 0 10.1895 0 7.65348C0 5.99097 2.88616 4.53483 7.20834 3.72896Z" />
    ),
    viewBox: `0 0 30 30`,
  },
  cross: {
